...
int main(){
  ...
  test_append();
  printf("Testing nappend: ");
  test_nappend();

  printf("Testing insert: ");
  test_insert();
  printf("Testing ninsert: ");
  test_ninsert();
  
  printf("Testing index: ");
  test_index();
  printf("Testing nindex: ");
  test_nindex();
  
  printf("Testing relplace: ");
  test_replace();
  printf("Testing nrelplace: ");
  test_nreplace();
  
  printf("Testing remove: ");
  test_remove();
  printf("Testing nremove: ");
  test_nremove();
...
void test_append(){
  ...
  StringBuilder_append(builder, str);
  StringBuilder_appendMultiple(builder, str2, 5);
...
void test_nappend(){
  ...
  StringBuilder_nappend(builder, str, 13);
  StringBuilder_nappendMultiple(builder, str2, 4, 5);
...
void test_insert(){
  ...
  StringBuilder_insert(builder, 5, "123");
  StringBuilder_insert(builder, 16, "4567");
  StringBuilder_insert(builder, 0, "89");
  ...
  StringBuilder_insertMultiple(builder, 5, "123", 2);
  StringBuilder_insertMultiple(builder, 0, "456", 3);
  StringBuilder_insertMultiple(builder, 28, "08", 4);
...
void test_ninsert(){
  ...
  StringBuilder_ninsert(builder, 5, "123", 3);
  StringBuilder_ninsert(builder, 16, "4567", 4);
  StringBuilder_ninsert(builder, 0, "89", 2);
  ...
  StringBuilder_ninsertMultiple(builder, 5, "123", 3, 2);
  StringBuilder_ninsertMultiple(builder, 0, "456", 3, 3);
  StringBuilder_ninsertMultiple(builder, 28, "08", 2, 4);
...
void test_index(){
  ...
  assert(StringBuilder_indexOf(builder, "Hel") == 0);
  assert(StringBuilder_lastIndexOf(builder, "Hel") == 29);
  assert(StringBuilder_indexOf(builder, "Dad") == builder->_size);
  assert(StringBuilder_lastIndexOf(builder, "Dad") == builder->_size);
...
void test_nindex(){
  ...
  assert(StringBuilder_nindexOf(builder, "Hel", 3) == 0);
  assert(StringBuilder_nlastIndexOf(builder, "Hel", 3) == 29);
  assert(StringBuilder_nindexOf(builder, "Dad", 3) == builder->_size);
  assert(StringBuilder_nlastIndexOf(builder, "Dad", 3) == builder->_size);
...
void test_replace(){
  ...
  StringBuilder_replace(builder, "Hello", "Hi");
  StringBuilder_replaceAll(builder, "World", "Za Wardo");
...
void test_nreplace(){
  ...
  StringBuilder_nreplace(builder, "Hello", 5, "Hi", 2);
  StringBuilder_nreplaceAll(builder, "World", 5, "Za Wardo", 8);
...
void test_remove(){
  ...
  StringBuilder_remove(builder, "Hello");
  StringBuilder_removeAll(builder, "World");
...
void test_nremove(){
  ...
  StringBuilder_removeChar(builder, ',');
  StringBuilder_removeAllChar(builder, ' ');
  StringBuilder_nremove(builder, "Hello", 5);
  StringBuilder_nremoveAll(builder, "World", 5);
  StringBuilder_removeAt(builder, 22);
  StringBuilder_removeAt(builder, 7);
  StringBuilder_removeAt(builder, 0);
  StringBuilder_removeRange(builder, 15, 2);
...
void test_build(){
  ...
  StringBuilder_ninsert(builder, 0, "123", 3);
  StringBuilder_nappend(builder, "456", 3);
